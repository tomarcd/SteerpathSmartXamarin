//
//  SPSmartNavigationViewDelegate.h
//  Steerpath
//
...
@class SPSmartNavigationView;

#pragma mark - SPSmartNavigationViewDelegate Definition

/**
    SPSmartNavigationViewDelegate

    The 'SPSmartNavigationViewDelegate' protocol defines a set of optional methods that you can use to receive map-related update messages.
    Because many map operations require the 'SPSmartNavigationView' class to load data asynchronously, the map view calls
    these methods to notify your application when specific operations complete.
 */
@protocol SPSmartNavigationViewDelegate <NSObject>
...
/**
    Called when navigation starts and route instructions are shown.
*/
